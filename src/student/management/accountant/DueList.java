...
public class DueList extends JFrame
{
    static JTable table;
    JLabel l1,l2;
    JButton b1,b2,b3;
    ...
    DueList() throws SQLException, ClassNotFoundException {
        ...
        l1 = JFrameSize.headline("Fee Due List");
    ...
    public static void getModel() throws SQLException, ClassNotFoundException {
